...
def main():
    ...
    print("|{:<20}|{:<20}|{:<20}".format(
        "Сортировка", "Среднее время (сек)", "Время (сек)"))
    print("|{:<20}|{:<20}|{:<20}|".format("Шейкер-сортировка",
                                          average_s_time, ', '.join(map(str, s_times))))
    print("|{:<20}|{:<20}|{:<20}|".format("Быстрая сортировка",
                                          average_q_time, ', '.join(map(str, q_times))))
    print("\n")
