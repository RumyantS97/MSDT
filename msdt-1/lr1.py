...
def info():
    ...
    print('2. С использованием цикла while найти в списке индекс первого двузначного')
    print('   элемента, кратного заданному числу')
    print('3. Отсортировать список (без использования стандартных функций сортировки)')
    print('   по убыванию старших цифр элементов списка (быстрая сортировка)')
...
print("любое число - автоматическая генерация списка из n случайных элементов в заданном пользователем диапазоне:")
v = int(input())
print("")
m = []
if v == 1:
...
def info():
    ...
    print('В исходном текстовом файле записаны строки, содержащие произвольные алфавитно-цифровые символы.\n'
          "Требуется написать программу, которая для каждой строки исходного файла будет составлять и выводить в результирующий файл\n"
          "слово из тех букв английского алфавита, которые встречаются во входных данных либо как строчные, либо как прописные,\n"
          "причем буквы должны идти в алфавитном порядке. Каждая буква должна быть распечатана один раз.\n"
          "Буквы построенного слова должны быть прописными. Если во входных данных встречаются все буквы английского алфавита,\n"
          'то следует вывести строчными буквами слово "no".')
    print()
...
if os.path.exists(fname1):
    ...
    def info():
        ...
        print('Алгоритм вычисления функции F(n), где n – натуральное число, задан следующими соотношениями:\n'
              ...
              '2. Количество кратных 3 четных цифр результата вычисления F(x), где x – число, заданное пользователем.')
        print()
...
def menu():
    print(
        "1. Реализуйте наивный алгоритм и алгоритм Кнута-Морриса-Пратта для поиска подстроки в строке. Сравните эффективность алгоритмов на различных входных данных.\n" +
