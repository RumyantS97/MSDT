...
class Visualizer:
    ...
    def create_buttons(self):
        buttons = [
            {"text": "Влево",
             "action": lambda: self.transformer.translate(-50, 0, 0),
             "rect": pygame.Rect(10, 60, 60, 30)},
            {"text": "Вправо",
             "action": lambda: self.transformer.translate(50, 0, 0),
             "rect": pygame.Rect(10, 100, 60, 30)},
            {"text": "Вверх",
             "action": lambda: self.transformer.translate(0, -50, 0),
             "rect": pygame.Rect(10, 140, 60, 30)},
            {"text": "Вниз",
             "action": lambda: self.transformer.translate(0, 50, 0),
             "rect": pygame.Rect(10, 180, 60, 30)},
            {"text": "Масштаб +",
             "action": lambda: self.transformer.rescale(1.1),
             "rect": pygame.Rect(10, 220, 90, 30)},
            {"text": "Масштаб -",
             "action": lambda: self.transformer.rescale(0.9),
             "rect": pygame.Rect(10, 260, 90, 30)},
            {"text": "Вращение X",
             "action": lambda: self.transformer.rotate(10, 0, 0),
             "rect": pygame.Rect(10, 300, 90, 30)},
            {"text": "Вращение Y",
             "action": lambda: self.transformer.rotate(0, 10, 0),
             "rect": pygame.Rect(10, 340, 90, 30)},
            {"text": "Вращение Z",
             "action": lambda: self.transformer.rotate(0, 0, 10),
