...
def room_2():
    ...
    action = input("Введите 'поднять', чтобы взять меч, или 'вперед', чтобы двигаться дальше: ")
    if action == "поднять":
...
def room_3():
    ...
    action = input("Введите 'атака', чтобы сразиться с монстром, или 'бег', чтобы убежать: ")
    if action == "атака":
        fight_monster()
    elif action == "бег":
...
def fight_monster():
    ...
    while player_health > 0 and monster_health > 0:
        action = input("Введите 'удар', чтобы атаковать монстра, или 'блок', чтобы защититься: ")
        if action == "удар":
...
def room_5():
    ...
    action = input("Введите 'говорить', чтобы поговорить с мудрецом, или 'вперед', чтобы двигаться дальше: ")
    if action == "говорить":
...
def room_6():
    ...
    action = input("Введите 'открыть', чтобы открыть сундук, или 'вперед', чтобы пройти дальше: ")
    if action == "открыть":
...
def room_8():
    ...
    action = input("Введите 'сразиться', чтобы атаковать дракона, или 'бег', чтобы убежать: ")
    if action == "сразиться":
        fight_dragon()
    elif action == "бег":
...
def fight_dragon():
    ...
    while player_health > 0 and dragon_health > 0:
        action = input("Введите 'удар', чтобы атаковать дракона, или 'блок', чтобы защититься: ")
        if action == "удар":
...
def room_9():
    ...
    action = input("Введите 'сразиться', чтобы сразиться с зомби, или 'бег', чтобы убежать: ")
    if action == "сразиться":
        fight_zombie()
    elif action == "бег":
...
def fight_zombie():
    ...
    while player_health > 0 and zombie_health > 0:
        action = input("Введите 'удар', чтобы атаковать зомби, или 'блок', чтобы защититься: ")
        if action == "удар":
            damage = random.randint(10, 20)
...
def room_12():
    ...
    action = input("Введите 'сразиться', чтобы атаковать монстра, или 'бег', чтобы убежать: ")
    if action == "сразиться":
        fight_monster_again()
    elif action == "бег":
