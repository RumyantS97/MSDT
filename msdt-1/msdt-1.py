...
def get_input(prompt, valid_responses):
    ...
    :param prompt: Строка, отображаемая пользователю для ввода данных.
    :param valid_responses: Список допустимых вариантов ответа.
    :return: Строка с корректным вводом пользователя.
    """
    while True:
...
def room_two():
    ...
    :return: Переход в следующую комнату или получение меча.
    """
...
def room_three():
    ...
    :return: Переход к бою с монстром или возвращение в предыдущую комнату.
    """
...
def fight_monster():
    ...
    Игрок и монстр обмениваются атаками, пока один из них не будет побежден.

    :return: Переход в следующую комнату при победе или окончание игры при поражении.
    """
...
def fight_dragon():
    ...
    Игрок и дракон обмениваются атаками, пока один из них не будет побежден.

    :return: Победа над драконом и завершение игры или проигрыш.
    """
...
def game_over():
    ...
    :return: Перезапуск игры или выход.
    """
