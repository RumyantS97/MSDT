...
class Employee:
    ...
    def __str__(self) -> str:
        return (
            f"Employee: {self.name}, Position: {self.position}, "
...
class Department:
    ...
    def __str__(self) -> str:
        return (
            f"Department: {self.name}, Number of Employees: {len(self.employees)}, "
...
class Company:
    ...
    def __str__(self) -> str:
        return (
            f"Company: {self.name}, Number of Departments: {len(self.departments)}, "
