...
from service import Account, BudgetService, Transaction
...
def test_add_transaction_to_different_accounts(account_name, initial_balance, transaction_amount, transaction_type,
                                               expected_balance):
    """
