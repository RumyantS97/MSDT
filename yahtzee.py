...
class Yahtzee:
    ...
    def small_straight(d1, d2, d3, d4, d5):
        ...
        if (tallies[0] == 1 and tallies[1] == 1 and tallies[2] == 1 and 
        tallies[3] == 1 and tallies[4] == 1):
    ...
    def large_straight(d1, d2, d3, d4, d5):
        ...
        if (tallies[1] == 1 and tallies[2] == 1 and tallies[3] == 1 and
        tallies[4] == 1 and tallies[5] == 1):
